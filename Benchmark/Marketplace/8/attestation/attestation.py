...
if __name__ == "__main__":
    ...
    attr_ID_Tax_Num_4 = int.to_bytes(69, 64, "big") # Attr id for tax number
    vc_Tax_Num_4 = int.to_bytes(1234123412, 64, "big") #tax number
    ...
    resultHash_Tax_Num_4 = hashlib.sha256(b"".join([attr_ID_Tax_Num_4[-32:], vc_Tax_Num_4[-32:]])).digest()
    resultHash_Tax_Num_4 += resultHash_Tax_Num_4
    ...
    sig_Tax_Num_4 = signKey.sign(resultHash_Tax_Num_4)
    ...
    outputs = [
        ...
        " ".join([str(i) for i in struct.unpack(">16I", attr_ID_Tax_Num_4)][-8:]),   #Tax Num AtrributID
        " ".join([str(i) for i in struct.unpack(">16I", vc_Tax_Num_4)][-8:]), #Tax Num VC Value
        write_signature_for_zokrates_cli(verifyKey, sig_Tax_Num_4, resultHash_Tax_Num_4), #Signature of the Issuers 
