...
if __name__ == "__main__":
    ...
    attr_ID_Zip_4 = int.to_bytes(9, 64, "big") # Attr id for zip code
    vc_Zip_4 = int.to_bytes(45054, 64, "big") #ZipCode
    ...
    attr_ID_Dob_4 = int.to_bytes(24, 64, "big") # Attr id for dateofbirth
    vc_Dob_4 = int.to_bytes(895507110, 64, "big") # birthdate | 18.05.1998
    ...
    resultHash_Zip_4 = hashlib.sha256(b"".join([attr_ID_Zip_4[-32:], vc_Zip_4[-32:]])).digest()
    resultHash_Zip_4 += resultHash_Zip_4
    ...
    resultHash_Dob_4 = hashlib.sha256(b"".join([attr_ID_Dob_4[-32:], vc_Dob_4[-32:]])).digest()
    resultHash_Dob_4 += resultHash_Dob_4
    ...
    sig_Zip_4 = signKey.sign(resultHash_Zip_4)
    ...
    sig2_Dob_4 = signKey.sign(resultHash_Dob_4)
    ...
    outputs = [
        ...
        " ".join([str(i) for i in struct.unpack(">16I", attr_ID_Zip_4)][-8:]),   #ZIP AtrributID
        " ".join([str(i) for i in struct.unpack(">16I", vc_Zip_4)][-8:]), #ZIP VC Value
        write_signature_for_zokrates_cli(verifyKey, sig_Zip_4, resultHash_Zip_4), #Signature of the Issuers 
        " ".join([str(i) for i in struct.unpack(">16I", attr_ID_Dob_4)][-8:]),
        " ".join([str(i) for i in struct.unpack(">16I", vc_Dob_4)][-8:]),
        write_signature_for_zokrates_cli(verifyKey, sig2_Dob_4, resultHash_Dob_4)
    ]
